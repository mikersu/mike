...
<footer id="footer" class="clearfix ">
    ...
    <!-- .subfooter start -->
    <!-- ================ -->
    <div class="subfooter" style="padding: 5px 10px;">
        <div class="container">

            <div class="row">
                <div class="col-md-6">
                    <span style="float:left;"><img src="images/logosmall.jpg"></span>
                    <span style="padding-left: 10px; font-size: 14px !important;">สำนักงานสวัสดิการสุขภาพ มหาวิทยาลัยรังสิต </span><br>
                    <span style="padding-left: 10px; font-size: 14px !important;">อาคาร 7 สำนักหอสมุด ชั้น 1 ด้านสระน้ำพุ </span><br>
                    <span style="padding-left: 10px; font-size: 14px !important;">เบอร์ห้องพยาบาล 3481 เบอร์ประกันอุบัติเหตุ 3493 </span>
                </span>
            </div>
            <div class="col-md-6 text-right">
               ...
               <ul class="sitemap">
                   ...
                   <li><a href="event.php">ข่าวสาร</a></li>
                   <li><a href="health_new.php">จุลสาร</a></li>
                   <li><a href="qa_doc.php">เอกสารQA</a></li>
               </ul>
               <br>Copyright @ 2015 All Rights Reserved. Warranty by Mr.Cherdpong
           </div>
       </div>
   </div>
</div>
...
<div class="style-switcher closed">
    ...
    <div class="clearfix body">
        ...
        <ul class="resetAll">
            <li class="btn btn-default btn-sm" title="Reset"><a href="http://htmlcoder.me/preview/the_project/v.1.0/index.html">Demos</a></li>
...
<!-- Mirrored from htmlcoder.me/preview/the_project/v.1.0/template/features-footers-google-maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jul 2015 09:14:51 GMT -->
</html>
